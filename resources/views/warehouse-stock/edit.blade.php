    ...
    <div class="container-fluid">
        ...
        <div class="page-content row items-center">
            ...
            <div class="form-group col-md-2">
                ...
                <input class="form-control" type="date" name="opening_stock_date" value="{{ $stock->stock_opening_date }}" id="openingStockDate" required>
            </div>
        ...
        <div class="page-content row">
            ...
            <div class="col-md-7">
                <div class="row">
                    <form action="{{ route('update-stock.update', $stock->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group col-md-6">
                ...
                @if(session()->has('draftStock'))
                    @forelse(session()->get('draftStock') as $draftStock)
                        <tr>
                            ...
                            <td><a class="text-danger draftRemove" href="javascript:void(0);" data-draftid="{{ $draftStock['draftId'] }}">Remove</a></td>
                        </tr>
                    @empty
                    @endforelse
                @endif
